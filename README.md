...
HWIFileDownload simplifies file download with `NSURLSession` on iOS. Parallel file download is controlled with a complete set of operations: start, cancel, pause, resume. Single file and total download progress is reported with `NSProgress`.
